...
public class Player : MonoBehaviour
{
    ...
    private void ProcessTranslation()
    {
        ...
        float xOffset = horiz * xSpeed * Time.deltaTime;
        ...
        transform.localPosition = new Vector3(transform.localPosition.x, Mathf.Clamp(yOffset + transform.localPosition.y, -4.5f , 4.5f), Mathf.Clamp(xOffset + transform.localPosition.z, -11, 12));
    }
